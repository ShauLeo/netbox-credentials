...
urlpatterns = [
    ...
    path(
        "assignments/",
        views.DeviceCredentialListView.as_view(),
        name="devicecredential_list",
    ),
    path(
        "assignments/add/",
        views.DeviceCredentialEditView.as_view(),
        name="devicecredential_add",
    ),
    path(
        "assignments/<int:pk>/",
        views.DeviceCredentialView.as_view(),
        name="devicecredential",
    ),
    path(
        "assignments/<int:pk>/edit/",
        views.DeviceCredentialEditView.as_view(),
        name="devicecredential_edit",
    ),
    path(
        "assignments/<int:pk>/delete/",
        views.DeviceCredentialDeleteView.as_view(),
        name="devicecredential_delete",
    ),
    # ── Bulk assign ─────────────────────────────────────────────────
    path(
        "bulk-assign/",
